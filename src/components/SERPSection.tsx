    ...
    <section className="py-32 px-6 bg-base text-cream border-t border-white/10 w-full overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row justify-center items-stretch gap-4 mt-16 max-w-3xl mx-auto"
        >
          {[
            {
              label: "Clients rank page 1",
              node: <CountUp end={93} suffix="%" duration={2} />,
            },
            {
              label: "Average traffic growth",
              node: <CountUp end={3.2} suffix="x" decimals={1} duration={2.2} />,
            },
            {
              label: "Avg. time to rank",
              node: <CountUp end={60} prefix="< " suffix="d" duration={1.6} />,
            },
          ].map((stat, i) => (
            <motion.div
              key={i}
              ...
              className="glass-card p-6 text-center rounded-2xl flex-1 min-w-[160px]"
            >
              <p className="text-3xl font-display font-bold text-mint">
                {stat.node}
              </p>
